    ...
    componentWillMount() {
        ...
        let release = (e, gestureState) => {
            ...
            if (position === 0 && change === -1) {
                change = 0;
            } else if (position + change >= this.props.components.length) {
                change = (this.props.components.length) - (position + change);
            }
            ...
            <ScrollView
                ...
                {this.props.components.map((component, index) => {
                    if (this.props.onPress) {
                        ...
                        return <View style={{height, width}} key={index}>{component()}</View>;
                    }
                })}
            </ScrollView>
            <View style={styles.buttons}>
                {this.props.components.map((image, index) => {
